...
## Wake word / env vars not read when root is a subdirectory
...
`.env` lives only at project root; `VITE_WAKE_WORD_ACCESS_KEY` and other `VITE_*` are available to the app.
